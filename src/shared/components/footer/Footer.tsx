  ...
  return (
    <footer className="bg-brand-blue-bg pt-10 px-0 pb-0">
          ...
          <ul className="space-y-4 list-none p-0">
            {contact.emails?.map((email, i) => (
              <li key={i} className="flex items-start gap-2">
                ...
                <span className="text-neutral-textMuted text-l break-all">{email}</span>
              </li>
            ))}
            ...
            {contact.phoneNumbers?.map((num, i) => (
              <li key={i} className="flex items-start gap-2">
                ...
                <span className="text-neutral-textMuted text-l break-all">{num}</span>
              </li>
            ))}
            ...
            {contact.address && (
              <li className="flex items-start gap-2">
                ...
                <span className="text-neutral-textMuted text-l">{contact.address}</span>
              </li>
            )}
          </ul>
        </div>
      ...
      <div className="border-t border-neutral-border py-6 mt-10 bg-black/10">
        <p className="text-center text-neutral-textMuted text-l">
